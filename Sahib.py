...
\033[1;91m☞ Auther     : AYAZ RAHI HACK MASTER
\033[1;92m☞ WhatsApp   : 03146152692
...
def menu():
	...
	print (S + '[' + P + '☞2' + S + ']' + S + ' Update B4_RAHI Tool')
	print (S + '[' + P + '☞3' + S + ']' + S + ' B4_RAHI WhatsApp Group')
...
def mb():
	...
	if bm =='':
	    ...
	    psb('WellCome To B4_RAHI')
	    psb('Congratulations B4_BALOCH Tool Has Been Updated Successfully')
	    psb('🔓User Name☆ RAHI✓')
	    psb('🔓Password ☆ STAR✓')
	    psb('Subscrib My Youtube Channel TOP4 YOU G HACK MASTER✓')
